...
export default function AdminAddStudent() {
    ...
    async function submitStudentForm() {
        ...
        if (sanity_check) {
            ...
            //handle old "name"
            studentInfo.name = studentInfo.first_name?(studentInfo.first_name+(studentInfo.last_name?" "+studentInfo.last_name:"")):studentInfo.last_name?studentInfo.last_name:""
            ...
            alert("Congradulations! You successfully added the student!")
            history.push("/admin")
    ...
    return (
        <div id="AddFormat">
            <Form className="login-form">
                <h4 className="text-center p-3">Add Student: </h4>
            </Form>
            ...
            <div id = "addStudentInside-form" >
                ...
                <Form autoComplete="off">
                    ...
                    <FormGroup>
                        ...
                        <Input
                            valid = {firstNameCheck.current === null? null:firstNameCheck.current}
                            invalid = {firstNameCheck.current === null? null:!firstNameCheck.current}
                            id="first_name"
                            name="first_name"
                    ...
                    <FormGroup>
                        ...
                        <Input
                            valid = {middleNameCheck.current === null? null:middleNameCheck.current}
                            invalid = {middleNameCheck.current === null? null:!middleNameCheck.current}
                            id="middle_name"
                            name="middle_name"
                            ...
                            onChange={e => {{setStudentInfo({
                                ...studentInfo,
                                middle_name: e.target.value.length > 0?e.target.value:null
                            })}}}
                    ...
                    <FormGroup>
                        ...
                        <Input
                            valid = {lastNameCheck.current === null? null:lastNameCheck.current}
                            invalid = {lastNameCheck.current === null? null:!lastNameCheck.current}
                            id="last_name"
                            name="last_name"
                    ...
                    <FormGroup>
                        ...
                        <br/>
                        <Input  type="select"  valid = {trackCheck.current === null? null:trackCheck.current}
                            invalid = {trackCheck.current === null? null:!trackCheck.current}  onChange={e => {console.log(e.currentTarget.value); setStudentInfo({
                            ...studentInfo,
                            track: e.currentTarget.value
                        })}}>
                            <option value="" disabled selected >Track</option>
                            {track_options.map(x =>  {return <option key={x.value} title= {x.label} value = {x.value}>{x.label}</option>})}
                        </Input>
                    </FormGroup>
                    <FormGroup>
                        <Label for="gender">
                    ...
                    <FormGroup>
                        ...
                        <Input type="select"  value= {studentInfo.status} valid = {statusCheck.current === null? null:statusCheck.current}
                           ...
                           {status_options.map(x =>  {return <option key={x.value} title= {x.label} value = {x.value}>{x.label}</option>})}
                        </Input>
